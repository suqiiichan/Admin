    ...
    <div class="container-scroller">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        ...
        <ul class="nav">
          ...
          <li class="nav-item menu-items">
            <a class="nav-link" href="../tables/mixer.php">
              <span class="menu-icon">
                <i class="mdi mdi-table-large"></i>
              </span>
          ...
          <li class="nav-item menu-items">
            <a class="nav-link" href="../tables/ball.php">
              <span class="menu-icon">
                <i class="mdi mdi-table-large"></i>
              </span>
        ...
        <!-- partial -->
              ...
              <div class="col-lg-12 stretch-card">
                <div class="card">
                 ...
                 <?php 
                    ...
                    <tr class="table-info">
                      ...
                      <td><?php echo $d['jp']; ?></td>
                      <td><a href="./hapus.php?id=<?php echo $d['idkaryawan']?>">Hapus</a></td>
                  </tr>
                ...
                ?>                     
                      ...
                      <input class="btn btn-primary mr-2" type="button" value="Export Excel" onclick="window.open('data-karyawan.php')">
                    </div>
                  </div>
                </div>
              </div>
